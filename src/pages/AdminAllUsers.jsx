    ...
    <div className="flex flex-1 h-screen">
      ...
      <div className="w-72 border-r bg-card overflow-hidden flex flex-col">
        <div className="p-4 border-b">
          <h2 className="font-semibold text-sm uppercase tracking-wide">All Users</h2>
        ...
        {!selectedUser ? (
          <div className="flex-1 flex items-center justify-center bg-muted/30">
            <div className="text-center">
              ...
              <p className="text-muted-foreground text-sm">Select a user from the sidebar to view chat history</p>
            </div>
          </div>
        ) : (
          <>
            <h2 className="font-semibold mb-2">User: {selectedUser.session_id}</h2>
        ...
        <Dialog open={showUserInfo} onOpenChange={setShowUserInfo}>
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-2">
              ...
              <p>
                <strong>Created At:</strong> {new Date(selectedUser.created_at.$date).toLocaleString()}
              </p>
              <p>
                <strong>Chat History Length:</strong> {selectedUser.chat_history.length}
              </p>
            </div>
            <DialogFooter>
